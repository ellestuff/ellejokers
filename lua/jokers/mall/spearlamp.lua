...
spearlamp.update = function(self, card, dt) if not slimeutils.card_obscured(card) then card.children.center:set_sprite_pos({x = card.ability.extra.variant-1, y = ellejokers.mod_data.config.nsfw and 1 or 0}) end end
